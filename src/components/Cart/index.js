...
const Cart = () => {
  ...
  return (
    <section className="ajarmobil-cart-page-area section_70">
      <Container>
        <Row>
          <Col lg={8} md={7}>
                ...
                <table className="table">
                  ...
                  <tbody>
                    <tr className="shop-cart-item">
                      <td className="ajarmobil-cart-preview">
                        <Link to="/product-single">
                          <img src={img1} alt="cart-1" />
                        </Link>
                      </td>
                      <td className="ajarmobil-cart-product">
                        <Link to="/product-single">
                          <p>car disk break</p>
                        </Link>
                      </td>
                      <td className="ajarmobil-cart-price">
                        <p>Rp180</p>
                      </td>
                      <td className="ajarmobil-cart-quantity">
                        <input type="number" defaultValue={1} />
                      </td>
                      <td className="ajarmobil-cart-total">
                        <p>Rp180</p>
                      </td>
                      <td className="ajarmobil-cart-close">
          ...
          <Col lg={4} md={5}>
            ...
            <div className="checkout-action">
              <Link to="/checkout" className="ajarmobil-btn">
                {t("cart.proceed")}
              </Link>
            </div>
          </Col>
