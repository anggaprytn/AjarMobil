...
const BlogDetails = () => {
  ...
  return (
    <section className="ajarmobil-blog-page-area section_70">
      <Container>
        <Row>
          <Col lg={8} md={7}>
            <div className="blog-page-left single-blog-page">
              <div className="single-blog">
                ...
                <div className="blog-text">
                  ...
                  <ul>
                    <li>
                      <FaUser /> <Link to="/">Anggaprytn</Link>
                    </li>
                    <li>
                      <FaCalendarAlt />
                      <Link to="/">13 Mar, 2023</Link>
                    </li>
                    <li>
                      <FaCommentAlt />
                ...
                <div className="ajarmobil-comment-list">
                ...
                <div className="ajarmobil-leave-comment">
