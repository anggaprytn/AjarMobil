...
const CarBooking = () => {
  ...
  return (
    <>
      <section className="ajarmobil-car-booking section_70">
        <Container>
          <Row>
            <Col lg={6}>
      ...
      <section className="ajarmobil-booking-form section_70">
        <Container>
          <Row>
            <Col lg={8}>
            ...
            <Col lg={4}>
              <div className="booking-right">
                ...
                <div className="ajarmobil-payment clearfix">
                  ...
                  <div className="payment">
                    ...
                    <label htmlFor="f-option">Bayar Ditempat</label>
                    <div className="check">
                      <div className="inside" />
                    </div>
                  </div>
                ...
                <div className="action-btn">
                  <Link to="/" onClick={onClick} className="ajarmobil-btn">
                    {t("researve_now")}
                  </Link>
                </div>
              </div>
